...
class Meals {
    ...
    static showReasult(mealsme, cont) {
        for (let meals of mealsme) {
            ...
            btn2.setAttribute("id", "shareBtn ");
            btn2.setAttribute("class", "mybtn ");
            btn2.setAttribute("onclick", "showm()");
...
function showRandomMeal() {
    getRandomApi().then(res => {
        ...
        button2.setAttribute("id", "shareBtn");
        button2.setAttribute("onclick", "showm()");
